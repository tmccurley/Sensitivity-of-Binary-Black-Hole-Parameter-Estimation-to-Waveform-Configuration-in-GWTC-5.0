"""
Extract the prespecified Batch A replacement event.

Replacement event
-----------------
GW241109_115924

This event replaces GW240629_145256 in the strict confirmatory sample.
The original event remains preserved as Tier B near-matched.

Expected raw file
-----------------
IGWN-GWTC5p0-29ebe06b7_25-GW241109_115924-combined_PEDataRelease.hdf5
...
Outputs
-------
GWTC5/data/processed/confirmatory_batch_A_replacement_01/
"""
...
OUTPUT_DIR = (
    ...
    / "data"
    / "processed"
    / "confirmatory_batch_A_replacement_01"
)
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

PREFIX = "confirmatory_batch_A_replacement_01"
...
manifest = {
    "replacement_for": "GW240629_145256",
...
with h5py.File(
    ...
    reduced_output.attrs[
        ...
        "Batch A prespecified replacement"
    )
